...
public interface StringStack<T> {
	...
	/**
	 * print the elements of the stack, starting from the item on the top, to the
	 * stream given as argument. For example, to print to the standard output you
	 * need to pass System.out as an argument. E.g., printStack(System.out);
	 */
